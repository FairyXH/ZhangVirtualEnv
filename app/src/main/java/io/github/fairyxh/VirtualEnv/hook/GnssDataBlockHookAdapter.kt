...
class GnssDataBlockHookAdapter(
    ...
    private fun hookGnssManagerService(classLoader: ClassLoader): Int {
        ...
        val ok = registrar.register(method) { chain ->
            ...
            if (!shouldBlockOriginal() || listener == null) return@register chain.proceed()
    ...
    private fun hookRealNmea(classLoader: ClassLoader): Int {
        ...
        val ok = registrar.register(method) { chain ->
            ...
            val virtual = if (shouldBlockOriginal()) backend.currentLocation() else null
            if (virtual != null) {
    ...
    private fun hookRealSvStatus(classLoader: ClassLoader): Int {
        ...
        val ok = registrar.register(method) { chain ->
            ...
            val virtual = if (shouldBlockOriginal()) buildVirtualGnssStatus() else null
            if (virtual != null) {
